...
class HtmlGame extends GameEngine {
  ...
  private def basicStructures = new TaskGroup("Exercícios básicos I", "html.basic",
  ...
  private def basicStructures2 = new TaskGroup("Exercícios básicos II", "html.basic2",
    new HtmlTask("Crie um parágrafo com \"Oi mundo\" como conteúdo", "basic_p1"));

  private def basicStructures3 = new TaskGroup("Exercícios básicos III", "html.basic3",
  ...
  private def images = new TaskGroup("Imagens", "html.images",
  ...
  private def multimedia = new TaskGroup("Multimídia", "html.multimedia",
  ...
  private def unorderedLists = new TaskGroup("Listas não ordenadas", "html.unorderedlists",
    new HtmlTask("Crie uma lista não ordenada com os elementos: Carro, Moto e Barco", "list_1"))

  private def orderedlists = new TaskGroup("Listas ordenadas", "html.orderedlists",
    new HtmlTask("Crie uma lista ordenada com os elementos: Abacaxi, Uva e Banana", "list_2"))

  private def definitionlists = new TaskGroup("Listas de definições", "html.definitionlists",
    new HtmlTask("Crie uma lista de definições com os elementos Grama e Sol e suas respectivas cores Verde e Amarelo", "list_3"));

  private def links = new TaskGroup("Links", "html.links",
  ...
  private def formats1 = new TaskGroup("Formatação de texto I", "html.formats",
  ...
  private def formats2 = new TaskGroup("Formatação de texto II", "html.formats2",
  ...
  private def tables = new TaskGroup("Tabelas", "html.tables",
    new HtmlTask("Crie uma tabela com borda, de 2 linhas e 2 colunas, com os números de 1 a 4", "table_1"));

  private def tables2 = new TaskGroup("Tabelas II", "html.tables2",
  ...
  private def forms3 = new TaskGroup("Formulários III - Controles", "html.forms3",
  ...
  private def forms4 = new TaskGroup("Formulários IV - Controles", "html.forms4",
  ...
  private def editable = new TaskGroup("Editable", "html.editable",
    new HtmlTask("Crie um parágrafo editável com o conteúdo \"O Brasil foi descoberto no ano 1500.\"", "editable_1"));

  private def structures = new TaskGroup("Estruturas do arquivo", "html.structures",
  ...
  private def svgs = new TaskGroup("SVG", "html.svg",
