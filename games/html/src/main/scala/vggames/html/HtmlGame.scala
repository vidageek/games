...
class HtmlGame extends GameEngine {
  ...
  def description = """Html é uma linguagem que foi criada para acrescentarmos informações à texto de forma que um computador seja capaz de entender o significado das estruturas do texto.
