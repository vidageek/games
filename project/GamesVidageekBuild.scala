...
object GamesVidageekBuild extends Build {
  ...
  object Dependencies {
    ...
    lazy val guiceBindings = "com.google.inject.extensions" % "guice-multibindings" % "3.0"
    ...
    lazy val scalaCompiler = "org.scala-lang" % "scala-compiler" % "2.10.3"
    lazy val sqlite = "org.xerial" % "sqlite-jdbc" % "3.7.2"
    lazy val aws = "com.amazonaws" % "aws-java-sdk" % "1.6.12"
  ...
  object TestDependencies {
    ...
    lazy val akkaTestkit = "com.typesafe.akka" %% "akka-testkit" % "2.2.3" % "test"
